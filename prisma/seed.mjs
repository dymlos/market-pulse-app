...
async function main() {
  ...
  const matesSnapshotBefore = await prisma.searchSnapshot.create({
    data: {
      trackedSearchId: matesSearch.id,
      capturedAt: new Date("2026-04-09T14:00:00.000Z"),
      source: SearchSnapshotSource.MANUAL,
      resultsCount: 5,
      notes: "Snapshot manual previo al ajuste de precio y titulo.",
    },
  });

  const matesSnapshotAfter = await prisma.searchSnapshot.create({
    data: {
      trackedSearchId: matesSearch.id,
  ...
  const mochilasSnapshotBefore = await prisma.searchSnapshot.create({
    data: {
      trackedSearchId: mochilasSearch.id,
      capturedAt: new Date("2026-04-15T17:30:00.000Z"),
      source: SearchSnapshotSource.MANUAL,
      resultsCount: 5,
      notes: "Snapshot manual previo a la reposicion propia.",
    },
  });

  const mochilasSnapshotAfter = await prisma.searchSnapshot.create({
    data: {
      trackedSearchId: mochilasSearch.id,
  ...
  await prisma.searchResultItem.createMany({
    data: [
      {
        searchSnapshotId: matesSnapshotBefore.id,
        position: 1,
        ...
        visibleFlags: "full, envio gratis, sponsored",
        isOwnListing: false,
        isSponsored: true,
      ...
      },
      {
        ...
        externalListingId: "MLA-RUTA-012",
        observedTitle: "Termo mate acero inoxidable 1 litro",
        observedPrice: 41990,
      ...
      },
      {
        searchSnapshotId: matesSnapshotBefore.id,
        position: 4,
        externalListingId: "MLA-GENERICO-013",
        observedTitle: "Mate termo acero 1L economico",
        observedPrice: 37200,
        observedSellerName: "Seller observado",
        visibleFlags: "promo",
        isOwnListing: false,
        isSponsored: false,
      ...
      },
      {
        ...
        observedTitle: "Mate termico acero inoxidable 1L",
        observedPrice: 41999,
        ...
        hasFull: false,
        isCatalogListing: false,
        notes: "Antes del ajuste, la publicacion propia quedaba debajo de tres competidores directos.",
      },
      {
        searchSnapshotId: matesSnapshotAfter.id,
        position: 1,
        competitorId: competitorNorth.id,
        externalListingId: "MLA-NORTH-010",
        observedTitle: "Termo acero 1L mate cebador premium full",
      ...
      {
        searchSnapshotId: mochilasSnapshotBefore.id,
        position: 1,
        competitorId: competitorRuta.id,
      ...
      },
      {
        ...
        position: 3,
        competitorId: competitorNorth.id,
        externalListingId: "MLA-NORTH-022",
        observedTitle: "Mochila trekking 45L tecnica impermeable",
        observedPrice: 96990,
        observedSellerName: "Outdoor North",
        visibleFlags: "envio gratis",
        isOwnListing: false,
      ...
      },
      {
        searchSnapshotId: mochilasSnapshotBefore.id,
        position: 5,
        externalListingId: "MLA-OBS-023",
        observedTitle: "Mochila outdoor 45 litros basica",
        observedPrice: 84990,
        observedSellerName: "Seller observado",
        visibleFlags: "sin full",
        isOwnListing: false,
        isSponsored: false,
        hasFreeShipping: false,
        hasFull: false,
      ...
      {
        searchSnapshotId: mochilasSnapshotAfter.id,
        position: 1,
        competitorId: competitorRuta.id,
        externalListingId: "MLA-RUTA-020",
        observedTitle: "Mochila trekking 45L reforzada con envio full",
      ...
      },
      {
        searchSnapshotId: mochilasSnapshotAfter.id,
        position: 5,
        externalListingId: "MLA-OBS-024",
        observedTitle: "Mochila camping 45L reforzada",
        observedPrice: 99990,
        observedSellerName: "Nuevo Seller",
        visibleFlags: "envio gratis",
        isOwnListing: false,
        isSponsored: false,
        hasFreeShipping: true,
  ...
  await prisma.csvImport.createMany({
    data: [
      ...
      },
      {
        ...
        validRows: 20,
        invalidRows: 0,
        summary: "Registro demo de resultados competitivos observados para snapshots comparables.",
      },
    ],
  });
